...
All notable changes to the OAS Structure Viewer are documented here.

The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.1.0/), and
this project adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).

Versions 0.1.0 and 0.1.1 were tagged retroactively on the two initial deployment
commits; their entries below reconstruct what each deployment contained.
