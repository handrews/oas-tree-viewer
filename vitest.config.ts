  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        "src/mcp/hosts/http.ts", // process entry / listen wiring (mirrors pipeline.worker.ts)
        "src/mcp/hosts/browser.ts", // live wiring, mirroring pipelineClient.ts (browser-verified; can't instantiate in node)
        "src/mcp/fixtures.browser.ts", // live wiring, mirroring pipelineClient.ts (browser-verified)
